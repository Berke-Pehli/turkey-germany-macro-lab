"""Summarize Germany baseline benchmark results.

This script compares simple benchmark models for one-month-ahead inflation
in Germany. It reports both in-sample and out-of-sample results for the
...
def load_model_data_de() -> pd.DataFrame:
    """Load and prepare the Germany modeling dataset.
...
def main() -> None:
    """Compute and report benchmark summary results for Germany."""
    df = load_model_data_de().copy()
