"""Run a Ridge regression benchmark for Germany inflation.

This script evaluates a Ridge regression model for one-month-ahead
inflation in Germany using a time-based train/test split. It is the next
...
def main() -> None:
    """Fit and evaluate a Ridge regression benchmark for Germany."""
