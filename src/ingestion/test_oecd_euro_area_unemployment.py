"""Simple OECD API ingestion test for euro area unemployment."""
...
def main() -> None:
    """Fetch, parse, and save OECD euro area unemployment data."""
    query_url = (
        "https://sdmx.oecd.org/public/rest/data/"
        "OECD.SDD.TPS,DSD_LFS@DF_IALFS_INDIC,1.0/"
        "EA.UNE_LF_M...Y._T.Y_GE15..M"
        "?dimensionAtObservation=AllDimensions"
        "&format=jsondata"
    )
    file_stub = "oecd_euro_area_unemployment"
    ...
    logger.info("OECD euro area unemployment fetch successful.")
