"""Simple OECD API ingestion test for euro area industrial production."""
...
def main() -> None:
    """Fetch, parse, and save OECD euro area industrial production data."""
    query_url = (
    ...
    file_stub = "oecd_euro_area_industrial_production"
    ...
    logger.info("OECD euro area industrial production fetch successful.")
